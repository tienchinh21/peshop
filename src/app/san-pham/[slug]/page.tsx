...
import { ProductDetailPage, getProductDetailCached, getTopProductSlugs } from "@/features/customer/products";
...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title,
      description,
      keywords: [product.productName, product.shopName, ...product.variants.flatMap(v => v.variantValues.map(vv => vv.propertyValue.value))].join(", "),
      openGraph: {
        title,
        description,
        url,
