...
export { PromotionTable, PromotionTableHeader, PromotionTableRow, PromotionTableLoading, PromotionTableEmpty, PromotionTablePagination } from "@/features/shop/campaigns/promotions/components/table";
export { OrderTable, OrderTableHeader, OrderTableRow, OrderTableLoading, OrderTableEmpty, OrderTablePagination } from "@/features/shop/orders/components/table";