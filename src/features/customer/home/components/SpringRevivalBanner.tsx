...
export default function SpringRevivalBanner() {
  return (
    <div className="p-3 md:p-6 relative overflow-hidden h-[200px] md:h-[300px]">
      {/* Background Image */}
      <Image
        src="/homev2-limited-time-offer.webp"
        alt="Furniture"
        fill
      ...
      <div className="relative z-10 max-w-xs">
        ...
        <Button
          variant="outline"
          size="sm"
          className="bg-white hover:bg-gray-50 text-gray-800 px-3 md:px-5 py-1.5 md:py-2.5 rounded-full font-medium border border-gray-800 transition-colors text-xs md:text-sm"
        >
          Shop Now
        </Button>
      </div>
