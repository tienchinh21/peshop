...
export default function ProductsPageWithFilters() {
  ...
  const [filters, setFilters] = useState<ProductFiltersState>({
    ...
    reviewPoint: searchParams.get("reviewPoint") ? parseFloat(searchParams.get("reviewPoint")!) : undefined
  });
  const {
    data,
    isLoading,
  ...
  const handleFilterChange = (newFilters: Partial<ProductFiltersState>) => {
    ...
    if (merged.categoryChildId) params.set("categoryChildId", merged.categoryChildId);
    ...
    if (merged.reviewPoint) params.set("reviewPoint", merged.reviewPoint.toString());
    router.push(`/san-pham?${params.toString()}`);
  };
  ...
  return <div className="min-h-screen bg-gray-50">
      <PageSection title="Tất cả sản phẩm" description={hasActiveFilters ? `Tìm thấy ${totalCount} sản phẩm` : "Khám phá hàng nghìn sản phẩm chất lượng cao"} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <aside className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-sm p-4 sticky top-4">
                ...
                <ProductFiltersComponent filters={filters} onFilterChange={handleFilterChange} onClearFilters={handleClearFilters} />
              </div>
            </aside>
            ...
            <main className="lg:col-span-3">
              ...
              {error && <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                  <p className="text-red-600">
                    Có lỗi xảy ra khi tải sản phẩm. Vui lòng thử lại sau.
                  </p>
                </div>}

              {!isLoading && !error && products.length === 0 && <div className="bg-white rounded-lg shadow-sm p-12 text-center">
