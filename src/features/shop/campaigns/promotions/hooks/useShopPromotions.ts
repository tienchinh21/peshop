...
import { getPromotions, createPromotion, updatePromotion, deletePromotion, addPromotionRules, addPromotionGifts, deletePromotionRules, deletePromotionGifts } from "../services";
import type { PromotionListFilters, CreatePromotionPayload, UpdatePromotionPayload, AddPromotionRulesPayload, AddPromotionGiftsPayload } from "../types";
import { toast } from "sonner";
import _ from "lodash";
export const shopPromotionKeys = {
  all: ["shop-promotions"] as const,
  lists: () => [...shopPromotionKeys.all, "list"] as const,
  list: (filters: PromotionListFilters) => [...shopPromotionKeys.lists(), filters] as const,
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: shopPromotionKeys.lists()
      });
      toast.success("Tạo chương trình thành công");
    },
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Tạo chương trình thất bại");
...
export const useUpdatePromotion = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: shopPromotionKeys.details()
      });
      toast.success("Cập nhật chương trình thành công");
    },
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Cập nhật chương trình thất bại");
      toast.error(errorMessage);
    }
  });
};
export const useDeletePromotion = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Xóa chương trình thất bại");
      toast.error(errorMessage);
    }
  });
};
export const useAddPromotionRules = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Thêm điều kiện thất bại");
      toast.error(errorMessage);
    }
  });
};
export const useAddPromotionGifts = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Thêm quà tặng thất bại");
      toast.error(errorMessage);
    }
  });
};
export const useDeletePromotionRules = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Xóa điều kiện thất bại");
      toast.error(errorMessage);
    }
  });
};
export const useDeletePromotionGifts = () => {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const errorMessage = _.get(error, "response.data.message", "Xóa quà tặng thất bại");
      toast.error(errorMessage);
    }
  });
};