...
import type { PromotionListResponse, PromotionListFilters, CreatePromotionPayload, UpdatePromotionPayload, AddPromotionRulesPayload, AddPromotionGiftsPayload } from "../types";
...
export const getPromotions = async (filters?: PromotionListFilters): Promise<PromotionListResponse> => {
...
export const updatePromotion = async (id: string, payload: UpdatePromotionPayload) => {
...
export const addPromotionRules = async (id: string, payload: AddPromotionRulesPayload[]) => {
  const response = await axiosJava.post(`/shop/promotion/${id}/rules`, payload);
  return response.data;
};
export const addPromotionGifts = async (id: string, payload: AddPromotionGiftsPayload[]) => {
