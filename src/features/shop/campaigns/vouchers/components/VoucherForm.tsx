...
import type { CreateVoucherPayload, ShopVoucher } from "../types";
...
export function VoucherForm({
  ...
  const handleChange = (field: keyof CreateVoucherPayload, value: any) => {
    setFormData(_.assign({}, formData, { [field]: value }));
  ...
  const handleCurrencyChange = (
    field: keyof CreateVoucherPayload,
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="name"
                value={formData.name}
                onChange={(e) => handleChange("name", _.get(e, "target.value"))}
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={formData.code}
                onChange={(e) =>
                  handleChange("code", _.toUpper(_.get(e, "target.value")))
                }
          ...
          <div className="space-y-2">
            ...
            <Select
              value={_.toString(formData.status)}
              onValueChange={(value) =>
                handleChange("status", _.toNumber(value))
              }
            >
              <SelectTrigger>
                <SelectValue />
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              value={_.toString(formData.type)}
              onValueChange={(value) => handleChange("type", _.toNumber(value))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
                ...
                {formData.type === VoucherType.PERCENTAGE ? (
                  <Input
                    ...
                    onChange={(e) =>
                      handleChange(
                        "discountValue",
                        _.toNumber(_.get(e, "target.value"))
                      )
                    }
                    placeholder="0"
                  />
                  ...
                  <Input
                    ...
                    inputMode="numeric"
                    value={
                      _.isNil(formData.discountValue)
                        ? ""
                        : formatInputCurrency(formData.discountValue)
                    }
                    onChange={(e) =>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    inputMode="numeric"
                    value={
                      _.isNil(formData.maxDiscountAmount)
                        ? ""
                        : formatInputCurrency(formData.maxDiscountAmount)
                    }
                    onChange={(e) =>
                      handleCurrencyChange(
                        "maxDiscountAmount",
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                inputMode="numeric"
                value={
                  _.isNil(formData.minimumOrderValue)
                    ? ""
                    : formatInputCurrency(formData.minimumOrderValue)
                }
                onChange={(e) =>
                  handleCurrencyChange(
                    "minimumOrderValue",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("quantity", _.toNumber(_.get(e, "target.value")))
                }
                placeholder="1"
              />
              {!_.isNil(errors.quantity) && (
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="1"
              />
              {!_.isNil(errors.limitForUser) && (
                <p className="text-sm text-red-500">{errors.limitForUser}</p>
              )}
            </div>
          </div>
        </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("startTime", _.get(e, "target.value"))
                }
              />
              {!_.isNil(errors.startTime) && (
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("endTime", _.get(e, "target.value"))
                }
              />
              {!_.isNil(errors.endTime) && (
