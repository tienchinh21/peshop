...
import type { ShopVoucherListResponse, ShopVoucherDetailResponse, VoucherListFilters, CreateVoucherPayload, UpdateVoucherPayload } from "../types";
...
export const getShopVouchers = async (filters?: VoucherListFilters): Promise<ShopVoucherListResponse> => {
  ...
  let sort = buildSortParam(filters || {});
  if (!sort) {
    sort = "createdAt,desc";
  }
