  ...
  onUploadClick
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start gap-6">
          {avatarPreview ? <div className="relative group">
              <div className="h-28 w-28 rounded-xl border-2 border-border overflow-hidden bg-muted">
                <img src={avatarPreview} alt="Avatar preview" className="h-full w-full object-cover" />
              </div>
              <button type="button" onClick={onRemoveAvatar} className="absolute -top-2 -right-2 h-7 w-7 rounded-full bg-destructive text-destructive-foreground shadow-md flex items-center justify-center hover:bg-destructive/90 transition-colors">
                <X className="h-4 w-4" />
              </button>
            </div> : <div className="h-28 w-28 rounded-xl border-2 border-dashed border-muted-foreground/25 flex items-center justify-center bg-muted/50">
