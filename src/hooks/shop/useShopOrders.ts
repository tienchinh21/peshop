...
import { getOrders, confirmOrders, rejectOrders } from "@/services/api/shops/order.service";
import type { OrderFilterParams } from "@/types/shops/order.type";
import { toast } from "sonner";
export const shopOrderKeys = {
  all: ["shop-orders"] as const,
  lists: () => [...shopOrderKeys.all, "list"] as const,
  list: (filters: OrderFilterParams) => [...shopOrderKeys.lists(), filters] as const
};
