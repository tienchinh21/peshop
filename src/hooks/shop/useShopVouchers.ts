...
import { getShopVouchers, getVoucherById, createVoucher, updateVoucher, deleteVoucher } from "@/services/api/shops/voucher.service";
import type { VoucherListFilters, CreateVoucherPayload, UpdateVoucherPayload } from "@/types/shops/voucher.type";
import { toast } from "sonner";
export const shopVoucherKeys = {
  all: ["shop-vouchers"] as const,
  lists: () => [...shopVoucherKeys.all, "list"] as const,
  list: (filters: VoucherListFilters) => [...shopVoucherKeys.lists(), filters] as const,
  ...
  return useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: shopVoucherKeys.lists()
      });
...
export const useUpdateVoucher = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: shopVoucherKeys.details()
      });
