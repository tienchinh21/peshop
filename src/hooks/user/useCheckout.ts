...
export const checkoutKeys = {
  ...
  virtualOrder: (payload: CreateVirtualOrderPayload) =>
    [...checkoutKeys.all, "virtual-order", payload] as const,
  shippingFee: (orderId: string) =>
    [...checkoutKeys.all, "shipping-fee", orderId] as const,
  vouchers: (orderId: string) =>
    [...checkoutKeys.all, "vouchers", orderId] as const,
  orderTotal: (orderId: string) =>
    [...checkoutKeys.all, "order-total", orderId] as const,
};
...
export const useVoucherEligibility = (
  orderId: string,
