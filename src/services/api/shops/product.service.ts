...
import type { Product, ProductPayload, CreateProductPayload, UpdateProductPayload, ProductResponse, ProductFilters, ProductVariant, ProductImage } from "@/types/shops/product.type";
