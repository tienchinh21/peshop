          ...
          <nav className="flex items-center justify-between py-2 md:py-3 text-sm font-medium">
            <div className="flex items-center gap-3 md:gap-6 overflow-x-auto scrollbar-hide flex-1 -mx-2 px-2">
              <Link
                href="/san-pham"
                className={cn(
                  "transition-colors relative pb-1 whitespace-nowrap flex-shrink-0",
                  isActive("/san-pham")
            ...
            <Link
              ...
              className="flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1.5 md:py-2 border border-primary hover:bg-primary/90 text-primary hover:text-white rounded-md transition-colors text-xs md:text-sm whitespace-nowrap flex-shrink-0 ml-2"
            >
