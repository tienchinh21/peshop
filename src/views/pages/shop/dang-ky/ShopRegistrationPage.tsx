...
import {
  AddressSelectModal,
  AddressSelection,
} from "@/components/common/Modal/AddressSelectModal";
import { createShop } from "@/services/api/shops/shop.service";
...
const ShopRegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If shop creation successful, update user role to include "Shop"
      if (user) {
